        ...
        <div id="carousel-indicators-dot" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-indicators carousel-indicators-dot">
                <button type="button" data-bs-target="#carousel-indicators-dot" data-bs-slide-to="0"
                    class=""></button>
                <button type="button" data-bs-target="#carousel-indicators-dot" data-bs-slide-to="1" class="active"
                ...
                <button type="button" data-bs-target="#carousel-indicators-dot" data-bs-slide-to="3"
                    class=""></button>
                <button type="button" data-bs-target="#carousel-indicators-dot" data-bs-slide-to="4"
                    class=""></button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="{{ asset('assets/static/photos/modern-home-office.jpg') }}">
                </div>
                <div class="carousel-item active">
                    <img class="d-block w-100" alt=""
                        src="{{ asset('assets./static/photos/blond-using-her-laptop-at-her-bedroom.jpg') }}">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="{{ asset('assets./static/photos/tropical-palm-leaves-floral-pattern-background.jpg') }}">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="{{ asset('assets./static/photos/woman-read-book-and-drink-coffee.jpg') }}">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="{{ asset('assets./static/photos/book-on-the-grass.jpg') }}">
                </div>
            </div>
        </div>
    </div>
